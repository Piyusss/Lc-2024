<h2><a href="https://leetcode.com/problems/range-frequency-queries">Range Frequency Queries</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>Design a data structure to find the <strong>frequency</strong> of a given value in a given subarray.</p>
