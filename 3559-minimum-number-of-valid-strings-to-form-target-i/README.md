<h2><a href="https://leetcode.com/problems/minimum-number-of-valid-strings-to-form-target-i">Minimum Number of Valid Strings to Form Target I</a></h2> <img src='https://img.shields.io/badge/Difficulty-Medium-orange' alt='Difficulty: Medium' /><hr><p>You are given an array of strings <code>words</code> and a string <code>target</code>.</p>
